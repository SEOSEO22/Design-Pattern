...
public class SafeFrame extends Frame implements ActionListener, Context {
    ...
    private Button buttonCCTV = new Button("CCTV");      // 차서연 : CCTV 버튼 추가
    ...
    public SafeFrame(String title) {
        ...
        panel.add(buttonCCTV); // 차서연 : 버튼 배치
        ...
        buttonCCTV.addActionListener(this); // 차서연 : 버튼 리스너 추가
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == buttonUse) {		// 금고 사용 버튼
            ...
            state.doPhone(this);
        } else if (e.getSource() == buttonCCTV) {	// 차서연 : CCTV 버튼  
            state.doCCTV(this);
        }
